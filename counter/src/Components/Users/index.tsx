...
const Users:FC<UsersProps> = ({isLoading, users,invited,
                                  searchValue,onChangeSearchValue,
                                  onClickAction, setIsSend}) => {
    return (
        <div className="usersBox">
            <div className="searcher">
                ...
                <input value={searchValue} onChange={(event) => onChangeSearchValue(event)} type="text"
            ...
            <div className="sendBox">
                ...
                >Send invite{invited.length > 1 ? "s" : ""}</button>
            </div>
        </div>
    );
};
